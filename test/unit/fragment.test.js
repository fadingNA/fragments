...
describe('Fragment class', () => {
  ...
  describe('Fragment()', () => {
    ...
    test('fragments get a created datetime string', () => {
      ...
      console.log('Date.parse result:', Date.parse(fragment.created));
      console.log('Created Date:', fragment.created);
  ...
  describe('save(), getData(), setData(), byId(), byUser(), delete()', () => {
    ...
    test('a fragment can be created and save() stores a fragment for the user', async () => {
      ...
      console.log("Test Jest 186" + fragment.ownerId, fragment.id, data)
      const fragment2 = await Fragment.byId('1234', fragment.id);
      console.log("Test Jest 188" + fragment.ownerId, fragment.id, data)
